...
pub fn user_starred_repos_response_decoder() -> decode.Decoder(UserStarredReposResponse) {
  use user <- decode.field("user", decode.optional(user_decoder()))
  decode.success(UserStarredReposResponse(user: user))
}

pub fn user_starred_repos_response_to_json(input: UserStarredReposResponse) -> json.Json {
  json.object([#("user", json.nullable(input.user, user_to_json))])
}

pub fn user_starred_repos(client: squall.Client, login: String, cursor: String) -> Result(Request(String), String) {
...
pub fn parse_user_starred_repos_response(body: String) -> Result(UserStarredReposResponse, String) {
